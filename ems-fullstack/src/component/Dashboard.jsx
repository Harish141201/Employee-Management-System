        ...
        <div className="ph-page dashboard-page">
            ...
            <section className="dashboard-grid">
                ...
                <aside className="ph-card dashboard-panel dashboard-panel--insights">
                    ...
                    <div className="dashboard-pulse"><div className="dashboard-pulse__chart"><ResponsiveContainer><PieChart><Pie data={[{ value: assignedEmployees }, { value: summary?.employeesWithoutDepartment || 0 }]} dataKey="value" innerRadius="52%" outerRadius="72%" startAngle={90} endAngle={-270} stroke="none">{[0, 1].map(index => <Cell key={index} fill={index ? '#e2e8f0' : '#2563eb'} />)}</Pie></PieChart></ResponsiveContainer><div className="dashboard-pulse__center"><strong>{assignmentRate}%</strong><span>assigned</span></div></div><p>Employees connected to a department</p></div>
