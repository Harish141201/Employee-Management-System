...
function Header({ onToggleSidebar }) {
    ...
    const titles = { '/dashboard': 'Dashboard', '/emplist': 'Employees', '/departments': 'Departments', '/attendance': 'Attendance', '/leave': 'Leave management', '/documents': 'Documents', '/profile': 'My profile' }
