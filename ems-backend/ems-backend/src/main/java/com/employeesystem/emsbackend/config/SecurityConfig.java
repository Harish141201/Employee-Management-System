...
import com.employeesystem.emsbackend.security.CustomUserDetailsService;
import com.employeesystem.emsbackend.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf.disable()) // stateless JWT API, no cookies/browser form submission to protect
